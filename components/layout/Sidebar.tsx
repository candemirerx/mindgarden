...
import { X, LogOut, User, TreePine, Leaf, Download, Upload, Database, Loader2, Mail, Eye, EyeOff, FileJson, FileText, FileType, ChevronDown, ChevronRight, Sparkles, Settings, ArrowLeft } from 'lucide-react';
                                                ...
                                                >
                                                    ...
                                                    <div className="flex flex-shrink-0 items-center gap-3 border-b border-sand-200 px-4 pb-4 pt-[calc(env(safe-area-inset-top)+1rem)] sm:px-6 sm:py-5">
                                                        <button
                                                            type="button"
                                                            onClick={() => setIsDataSectionOpen(false)}
                                                            aria-label="Veri yönetiminden geri dön"
                                                            className="-ml-1 flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl text-sand-600 transition-colors hover:bg-sand-100 hover:text-sand-900"
                                                        >
                                                            <ArrowLeft size={20} />
                                                        </button>
                                                        <div className="flex min-w-0 items-center gap-3">
                                                            ...
                                                            <div className="min-w-0">
                                                                <h2 className="truncate text-lg font-semibold text-sand-900">Veri Yönetimi</h2>
                                                                <p className="truncate text-xs text-sand-500">İçe ve dışa aktarma araçları</p>
                                                            </div>
                                                        </div>
                                                    </div>
